...
package com.github.oogasawa.llmchat.actor;

import com.github.oogasawa.llmchat.rest.ChatEvent;
import com.github.oogasawa.llmchat.service.ModelSet;
import com.github.oogasawa.llmchat.service.ModelSetBuilder;
...
public class ChatActor {
    ...
    /**
     * Returns a copy of recent conversation messages for the given user.
     * Returns an empty list if no history exists.
     *
     * @param userId the user identifier
     * @param limit  maximum number of messages to return
     * @return list of recent chat messages (newest last)
     */
    public List<ChatMessage> getRecentHistory(String userId, int limit) {
        List<ChatMessage> history = userHistories.get(userId);
    ...
    /**
     * Returns the set of user IDs that have conversation history.
     */
    public java.util.Set<String> getActiveUserIds() {
        return java.util.Set.copyOf(userHistories.keySet());
    }
